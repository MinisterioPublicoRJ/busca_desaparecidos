...
SELECT
    VTMA_DT_NASCIMENTO,
    floor(MONTHS_BETWEEN(CURRENT_DATE, VTMA_DT_NASCIMENTO) / 12) IDADE,
    BDMT_BASE64,
    SNCA_DT_FATO,
    BAIR_LATITUDE,
    BAIR_LONGITUDE,
...
LEFT JOIN
    SILD_ENDERECO_FATO
ON SILD_SINDICANCIA.SNCA_DK = SILD_ENDERECO_FATO.SIES_SNCA_DK
LEFT JOIN
    CORP.CORP_CIDADE
...
LEFT JOIN
    SILD_BLOB_DOCUMENTO
ON SILD_SINDICANCIA.SNCA_DK = SILD_BLOB_DOCUMENTO.BDMT_DK
LEFT JOIN
    SILD_VITIMA
ON SILD_VITIMA.VTMA_DK = SILD_SINDICANCIA.SNCA_DK
"""
