...
PESSOAS_POSSIVEIS AS (
	...
	FROM SILD_FILTRADO
	LEFT JOIN
	    SILD_ENDERECO_FATO ON SILD_FILTRADO.SNCA_DK = SILD_ENDERECO_FATO.SIES_SNCA_DK 
	LEFT JOIN
	    CORP.CORP_CIDADE
	...
	LEFT JOIN
	    SILD_DOCUMENTO
	ON SILD_FILTRADO.SNCA_DK = SILD_DOCUMENTO.DMTO_SNCA_DK 
	...
	LEFT JOIN
	    SILD_VITIMA
	ON SILD_VITIMA.VTMA_DK = SILD_FILTRADO.SNCA_VTMA_DK
),
SCORES AS (
